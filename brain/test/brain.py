...
class Brain(q_learning.Brain):
  ...
  def _build_model(self):
    ...
    x = keras.layers.Conv2D(32*2*2*2, kernel_size=(8, 8), strides=(4, 4), activation='relu')(input)
    ...
    x = keras.layers.Dense(256*2*2*2*2*2*2, activation='relu')(x)
    x = keras.layers.Dense(256*2*2, activation='relu')(x)
